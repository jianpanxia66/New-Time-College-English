        ...
        <div class="otherLoginWays" v-if="mConfigs.otherLoginWays" v-show="hideFooter">
            ...
            <div class="icons">
                <slot name="otherLoginWays_icons">
                    <a href="https://graph.qq.com/oauth2.0/show?which=Login&display=pc&response_type=code&redirect_uri=http%3A%2F%2Fspcdp.cdposs.qq.com%2Fauth%2Fcallback&client_id=101477813&state=http%3A%2F%2Fspcdp.cdposs.qq.com%2F"><img class="icon" src="../assets/images/icon_QQ.png"  @click="$emit('qqLogin')"></a>
